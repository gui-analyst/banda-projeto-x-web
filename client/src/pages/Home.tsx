                  ...
                  <div className="flex flex-col md:flex-row gap-12 items-start">
                    <div className="flex-1 space-y-6">
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-12">
                        ...
                        <button
                          onClick={() => setActiveTab('sobre')}
                          className="text-white hover:text-[#FF2E4A] font-bold display-font text-xs md:text-base inline-flex items-center gap-2 group transition-colors duration-300 whitespace-nowrap flex-shrink-0 hover:border-b-2 hover:border-[#FF2E4A] pb-1 md:mt-0 mt-2 md:absolute md:top-8 md:right-12"
                        >
          ...
          <section className="w-screen relative left-1/2 right-1/2 -mx-[50vw] py-20 px-4 md:px-12 fade-in-up" style={{ backgroundColor: '#FFFFFF' }}>
            <div className="container mx-auto">
                  <div className="flex flex-col gap-8">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-12 relative">
                      <div className="flex-1 min-w-0">
                      ...
                      <button
                        ...
                        className="text-black hover:text-[#FF2E4A] font-bold display-font text-xs md:text-base inline-flex items-center gap-2 group transition-colors duration-300 whitespace-nowrap flex-shrink-0 hover:border-b-2 hover:border-[#FF2E4A] pb-1 md:mt-0 mt-2 md:absolute md:top-0 md:right-0"
                      >
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-12 relative">
                      ...
                      <button
                        ...
                        className="text-white hover:text-black font-bold display-font text-xs md:text-base inline-flex items-center gap-2 group transition-colors duration-300 whitespace-nowrap flex-shrink-0 hover:border-b-2 hover:border-black pb-1 md:mt-0 mt-2 md:absolute md:top-0 md:right-0"
                      >
                        VER TODOS <ArrowRight className="w-3 h-3 md:w-4 md:h-4 group-hover:translate-x-1 transition-all duration-300" />
                      </button>
                    </div>
